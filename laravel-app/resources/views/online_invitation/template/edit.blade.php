...
@php
    ...
    $bgPreviewUrl = null;
    if ($bgRef) {
        if (preg_match('#^https?://#i', $bgRef) || preg_match('#^data:image/#i', $bgRef)) {
            $bgPreviewUrl = \App\Support\OnlineInvitationUrl::ensurePublicInAppUrl($bgRef);
        } elseif (preg_match('#^/(public/)?images/#i', $bgRef) || preg_match('#^images/#i', $bgRef)) {
            $bgPreviewUrl = \App\Support\OnlineInvitationUrl::ensurePublicInAppUrl(asset(ltrim($bgRef, '/')));
        }
    }
    $borderColor = old('border_color', $data->border_color ?: '#c8a75e');
    $fontColor = old('font_color', $data->font_color ?: '#f3e7c1');
    $fontSize = (int) old('font_size', $data->font_size ?: 16);
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Any portrait image is fine — it will be auto-fitted to 1024×1536 px. Leave empty to keep the current background.</small>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        <div class="col-lg-5 mt-4 mt-lg-0">
                            <div class="oi-tpl-preview-wrap">
                                ...
                                <div class="oi-tpl-preview" id="oi-tpl-preview">
                                    <div class="oi-tpl-preview-bg" id="oi-tpl-preview-bg"
                                         @if($bgPreviewUrl) style="background-image:url('{{ $bgPreviewUrl }}');" @endif></div>
                                    ...
                                    <div class="oi-tpl-preview-frame">
                                        <div class="oi-tpl-preview-border" id="oi-tpl-preview-border">
                                            <div class="oi-tpl-pv-title" id="oi-tpl-pv-title">{{ $data->name }}</div>
