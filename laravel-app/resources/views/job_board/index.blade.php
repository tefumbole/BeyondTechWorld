    ...
    <div class="container-fluid jb-shell">
        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap mb-4" style="gap:12px;">
            <div>
                ...
                <p class="jb-subtitle">Manage public job postings shown on Apply Now.</p>
            </div>
            ...
            <div class="table-responsive">
                <table class="table mb-0">
                    ...
                    <tbody>
                        @forelse($items as $job)
                            <tr>
                                ...
                                <td class="text-right text-nowrap">
                                    ...
                                    <a href="{{ route('jobs.edit', $job->id) }}" class="btn btn-sm btn-primary"><i class="dripicons-pencil"></i></a>
                                    <form method="POST" action="{{ route('jobs.destroy', $job->id) }}" class="d-inline" onsubmit="return confirm('Delete this job and its applications?');">
                                        @csrf
                        ...
                        @empty
                            <tr><td colspan="7" class="text-center text-muted py-4">No job postings found.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
