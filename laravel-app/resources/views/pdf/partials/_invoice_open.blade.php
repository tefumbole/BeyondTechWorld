@php
    ...
    $invoiceWatermark = ! empty($invoiceLetterhead['watermark_path']) && file_exists($invoiceLetterhead['watermark_path'])
        ? \App\Support\Letterhead::pdfImage($invoiceLetterhead['watermark_path'], 700)
        : null;
@endphp
@if($invoiceWatermark)
...
@endif
@if($invoiceHasHeader)
    <img src="{{ \App\Support\Letterhead::pdfImage($invoiceLetterhead['header_path'], 1400) }}" class="inv-header-img" alt="">
@endif
