...
const DEFAULTS = {
  company_name: import.meta.env.VITE_COMPANY_NAME || 'Alpha Bridge Technologies Ltd',
  default_header: import.meta.env.VITE_COMPANY_NAME || 'Alpha Bridge Technologies Ltd',
